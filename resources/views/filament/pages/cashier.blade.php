    ...
    <div class="grid grid-cols-12 text-gray-900 dark:text-neutral-100 gap-8">
        @if ($activeTab === 'carts')
            <div class="col-span-12">
                <div
                    class="flex flex-col gap-4 rounded-2xl border-2 border-gradient bg-gradient-to-br from-white via-blue-100/40 to-sky-100/40 p-4
               shadow-lg dark:border-neutral-800 dark:from-neutral-900 dark:to-neutral-900/80">

                    {{-- Row atas: Judul + info kasir/toko --}}
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500/20 to-blue-500/20 text-sky-700 shadow-sm
                        ...
                        <div class="flex items-center gap-2 text-[11px] text-gray-600 dark:text-neutral-400">
                            <span
                                class="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-sky-100 to-blue-100 px-3 py-1.5 shadow-md font-medium text-sky-700 dark:from-sky-900/40 dark:to-blue-900/40
                    ...
                    <div class="grid gap-4 md:grid-cols-3 mb-4">
                        {{-- Mode Transaksi Tab --}}
                        <div class="space-y-2">
                            <label class="block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <!-- Normal Mode Button -->
                                <button type="button"
                                    wire:click="$set('checkoutMode', 'normal')"
                                    @class([
                                        'relative inline-flex items-center gap-2 px-3 py-2.5 rounded-lg font-medium text-sm transition-all duration-200',
                                        'bg-sky-600 text-white shadow-lg hover:bg-sky-700 border-2 border-sky-600' => $checkoutMode === 'normal',
                                        'bg-white text-gray-700 border-2 border-gray-200 hover:border-gray-300 dark:bg-neutral-800 dark:text-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600' => $checkoutMode !== 'normal',
                                    ])>
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Service Mode Button -->
                                <button type="button"
                                    wire:click="$set('checkoutMode', 'service')"
                                    @class([
                                        'relative inline-flex items-center gap-2 px-3 py-2.5 rounded-lg font-medium text-sm transition-all duration-200',
                                        'bg-amber-600 text-white shadow-lg hover:bg-amber-700 border-2 border-amber-600' => $checkoutMode === 'service',
                                        'bg-white text-gray-700 border-2 border-gray-200 hover:border-gray-300 dark:bg-neutral-800 dark:text-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600' => $checkoutMode !== 'service',
                                    ])>
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="space-y-2 md:col-span-2 animate-in fade-in duration-300">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2">
                                        <svg class="h-5 w-5 text-gray-600 dark:text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                                        </svg>
                                    </div>
                                </div>

                                <div class="inline-flex items-start gap-2 rounded-lg bg-amber-50 p-3 dark:bg-amber-900/20">
                                    <svg class="mt-0.5 h-4 w-4 flex-shrink-0 text-amber-600 dark:text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 8a6 6 0 06-12 0 6 6 0 0112 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V4a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                    </svg>
                                    <p class="text-xs font-medium text-amber-800 dark:text-amber-200">
                                        Setelah memilih Service Order, item part & jasa akan otomatis ditambahkan ke keranjang transaksi.
                                    </p>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        <div class="space-y-2">
                            <label class="block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200">
                                <span class="flex items-center gap-2">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.856-1.488M15 6a3 3 0 11-6 0 3 3 0 016 0zM6 20h12a6 6 0 00-6-6 6 6 0 00-6 6z"></path>
                                    </svg>
                                    Pelanggan
                                </span>
                            </label>
                        ...
                        <div class="space-y-2">
                            <label class="block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200">
                                <span class="flex items-center gap-2">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h10m4 0a1 1 0 11-2 0 1 1 0 012 0zM6 6h.01M6 10h.01M6 14h.01M6 18h.01"></path>
                                    </svg>
                                    Metode Pembayaran
                                </span>
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <div class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2">
                                    <svg class="h-5 w-5 transition-colors duration-200 @if($selectedDiscountTypeId) text-green-600 dark:text-green-300 @else text-gray-600 dark:text-neutral-400 @endif" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                                    </svg>
                                </div>
                            </div>
                    ...
                    @if ($universalDiscountMode)
                        <div class="mt-4 animate-in fade-in duration-300 rounded-lg border-2 border-purple-200 bg-purple-50 p-4 dark:border-purple-900/40 dark:bg-purple-900/20">
                            <label class="mb-3 block text-xs font-bold uppercase tracking-wide text-purple-900 dark:text-purple-200">
                                <span class="flex items-center gap-2">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="flex-1">
                                    <input type="number" step="0.01" min="0" wire:model.lazy="universalDiscountValue"
                                ...
                                <button type="button"
                                    wire:click="$set('universalDiscountMode', null)"
                    ...
                    @else
                        <div class="mt-4">
                            <button type="button"
                                wire:click="$set('universalDiscountMode', 'percent')"
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-col">
                            <div class="mb-3 flex items-center justify-between">
                                <h3 class="text-sm font-bold uppercase tracking-wide text-gray-800 dark:text-neutral-100 flex items-center gap-2">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                                    </svg>
                                    Keranjang Belanja
                                </h3>
                                <span class="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-sky-300 to-blue-300 px-3 py-1 text-xs font-bold text-sky-900 shadow-md dark:bg-sky-900/40 dark:text-sky-200">
                            ...
                            <div class="-m-1.5 overflow-x-auto">
                                <div class="p-1.5 min-w-full inline-block align-middle">
                                    <div
                                        class="bg-gradient-to-br from-white to-gray-50 border-2 border-sky-200/60 rounded-xl shadow-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                                        <!-- Table -->
                                        <table class="min-w-full divide-y divide-sky-200/40 dark:divide-neutral-700">
                                            <thead class="bg-gradient-to-r from-sky-600 to-blue-600 dark:from-neutral-800 dark:to-neutral-900">
                                                <tr>
                                            ...
                                            <tbody class="divide-y divide-sky-200/40 dark:divide-neutral-700 [&>tr:nth-child(odd)]:bg-sky-50/40 [&>tr:nth-child(odd)]:dark:bg-neutral-800/50">
                                                @forelse ($this->carts as $index => $cart)
                                                    ...
                                                    @endphp
                                                    <tr class="transition-colors duration-200 hover:bg-sky-100/60 dark:hover:bg-neutral-800/80">
                                                        {{-- Product --}}
                                                        <td class="px-6 py-4">
                                                            <div class="flex flex-col">
                                                                <span
                                                    ...
                                                    <tr>
                                                        <td colspan="7"
                                                            ...
                                                            <div class="flex flex-col items-center gap-2">
                                                                <svg class="h-12 w-12 text-gray-300 dark:text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                                                                </svg>
                                                                <p class="text-sm font-medium text-gray-500 dark:text-neutral-400">Keranjang masih kosong</p>
                                                                <p class="text-xs text-gray-400 dark:text-neutral-500">Mulai dengan menambahkan produk dari tab Produk</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforelse
            ...
            <div class="col-span-12 grid grid-cols-1 md:grid-cols-1 gap-8">
                {{-- Summary --}}
                <div
                    class="rounded-2xl border-2 border-sky-200/60 bg-gradient-to-br from-white via-blue-100/50 to-cyan-50/40 p-6 shadow-xl
               dark:border-neutral-700 dark:from-neutral-900 dark:via-blue-900/10 dark:to-neutral-900">
                    <h3 class="mb-5 text-sm font-bold uppercase tracking-wide text-gray-800 dark:text-neutral-100 flex items-center gap-2">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        Ringkasan Total
                    ...
                    <dl class="space-y-3">
                        <div class="flex items-center justify-between rounded-lg bg-white/60 px-4 py-2.5 dark:bg-neutral-800/40">
                        ...
                        @if($this->itemDiscountTotal > 0)
                            <div class="flex items-center justify-between rounded-lg bg-red-50/60 px-4 py-2.5 dark:bg-red-900/20">
                        ...
                        <div class="flex items-center justify-between rounded-lg bg-white/60 px-4 py-2.5 dark:bg-neutral-800/40">
                            <dt class="text-sm font-medium text-gray-600 dark:text-neutral-300">Setelah Diskon Item</dt>
                            <dd class="text-sm font-semibold text-gray-900 dark:text-neutral-100">
                        ...
                        @if($this->universalDiscountAmount > 0)
                            <div class="flex items-center justify-between rounded-lg bg-purple-50/60 px-4 py-2.5 dark:bg-purple-900/20">
                                <dt class="text-sm font-medium text-purple-600 dark:text-purple-400 flex items-center gap-2">
                                    <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                    </svg>
                                    Diskon Universal
                        ...
                        <div
                            class="mt-4 flex items-center justify-between rounded-xl border-2 border-sky-300 bg-gradient-to-r from-sky-500/10 to-blue-500/10 px-5 py-4 dark:border-sky-700 dark:from-sky-900/20 dark:to-blue-900/20">
                ...
                {{-- Pembayaran --}}
                <div
                    class="rounded-2xl border-2 border-emerald-200/60 bg-gradient-to-br from-white via-emerald-100/50 to-teal-50/40 p-6 shadow-xl
               dark:border-neutral-700 dark:from-neutral-900 dark:via-emerald-900/10 dark:to-neutral-900">
                    <h3 class="mb-5 text-sm font-bold uppercase tracking-wide text-gray-800 dark:text-neutral-100 flex items-center gap-2">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h10m4 0a1 1 0 11-2 0 1 1 0 012 0zM6 6h.01M6 10h.01M6 14h.01M6 18h.01"></path>
                        </svg>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="mb-2 block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200">
                                Status Pembayaran
                            </label>
                            ...
                            <p class="mt-2 text-xs font-medium text-gray-500 dark:text-neutral-400 flex items-start gap-2">
                        ...
                        @if ($paymentStatus !== 'unpaid')
                            <div class="animate-in fade-in duration-300 space-y-4 rounded-xl bg-white/70 p-4 dark:bg-neutral-800/50">
                                <div>
                                    <label class="mb-2 block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200 flex items-center gap-2">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <button type="button" wire:click="checkout"
                            class="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-emerald-500 to-green-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:from-emerald-600 hover:to-green-700 hover:shadow-xl active:scale-95">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($activeTab === 'products')
            {{-- Search Section --}}
            <div class="col-span-12">
                <div class="rounded-2xl border-2 border-sky-200/60 bg-gradient-to-br from-white via-blue-100/50 to-cyan-50/40 p-6 shadow-xl dark:border-neutral-700 dark:from-neutral-900 dark:via-blue-900/10 dark:to-neutral-900">
                    <div class="space-y-4">
                        <h4 class="text-sm font-bold uppercase tracking-wide text-gray-800 dark:text-neutral-100 flex items-center gap-2">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="relative">
                            <div class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2">
                                <svg class="h-5 w-5 text-gray-500 dark:text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            {{-- Category Filter --}}
                            <div class="space-y-2">
                                <label class="block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-neutral-200 flex items-center gap-2">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="col-span-12 flex flex-col md:flex-col lg:flex-row gap-8">
                ...
                <div class="grid grid-cols-4 min-w-full gap-6">
                    @foreach ($this->products as $product)
                        ...
                        <div class="group flex flex-col rounded-2xl border-2 border-gradient bg-gradient-to-br from-white to-sky-50/40 shadow-lg transition-all duration-300 hover:shadow-2xl hover:border-sky-400 hover:-translate-y-1 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-sky-600 overflow-hidden">
                            {{-- Image Section --}}
                            <div class="relative p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-neutral-800 dark:to-neutral-900">
                                <div class="rounded-xl bg-white dark:bg-neutral-800 p-3 shadow-sm">
                                    @if ($images->isEmpty())
                                        <div class="aspect-square flex items-center justify-center rounded-xl text-sm text-neutral-400 bg-neutral-200 dark:bg-neutral-700 font-medium">
                                            <svg class="h-12 w-12 text-neutral-300 dark:text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                            </svg>
                                        </div>
                                    @else
                                        <div class="relative overflow-hidden rounded-xl bg-neutral-200 dark:bg-neutral-700" data-product-carousel>
                                            ...
                                            @if ($images->count() > 1)
                                                ...
                                                <div class="absolute inset-x-0 bottom-3 flex items-center justify-center gap-1.5">
                                                    @foreach ($images as $index => $media)
                                                        <button type="button" data-carousel-dot data-index="{{ $index }}"
                            ...
                            <div class="flex-1 flex flex-col p-4 space-y-3">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <svg class="h-4 w-4 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m0 0l8 4m0 0l8-4m0 0v10l-8 4m0 0l-8-4m0 0v10l8 4m0 0l8-4"></path>
                                        </svg>
                                        <span class="text-xs font-bold uppercase tracking-wide text-emerald-700 dark:text-emerald-300">Stok: {{ $product->quantity }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2 border-t border-sky-200/60 dark:border-neutral-700/50 pt-3">
                                    <div class="rounded-lg bg-sky-50/60 px-3 py-2.5 dark:bg-sky-900/20">
                                        <p class="text-xs font-medium text-gray-600 dark:text-neutral-400">Harga Jual</p>
                                        <p class="text-lg font-bold text-sky-700 dark:text-sky-300">Rp {{ number_format($product->productPrice->selling_price ?? 0, 0, ',', '.') }}</p>
                                    </div>

                                    <div class="rounded-lg bg-sky-50/80 px-3 py-2 dark:bg-neutral-800/40">
                                        <div class="text-xs font-medium text-gray-700 dark:text-neutral-300 truncate">{{ $product->product->keyword }}</div>
                                    </div>

                                    <div class="rounded-lg bg-sky-50/80 px-3 py-2 dark:bg-neutral-800/40">
                                        <div class="text-[11px] text-gray-600 dark:text-neutral-400">Kompatibilitas</div>
                                        <div class="text-xs font-medium text-gray-700 dark:text-neutral-300 truncate">{{ $product->product->compatibility }}</div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-3 gap-2 text-[11px]">
                                        <div class="rounded-lg bg-sky-50/80 px-2 py-2 dark:bg-neutral-800/40">
                                            ...
                                            <div class="font-semibold text-gray-700 dark:text-neutral-300">{{ substr($product->product->type, 0, 10) }}</div>
                                        </div>
                                        <div class="rounded-lg bg-sky-50/80 px-2 py-2 dark:bg-neutral-800/40">
                                            <span class="text-gray-600 dark:text-neutral-400">Ukuran</span>
                                            <div class="font-semibold text-gray-700 dark:text-neutral-300">{{ substr($product->product->size, 0, 10) }}</div>
                                        </div>
                                        <div class="rounded-lg bg-amber-50/60 px-2 py-2 dark:bg-amber-900/20">
                                            <span class="text-amber-600 dark:text-amber-300 text-[10px]" title="{{ $product->product->sku }}">SKU</span>
                                            <div class="font-semibold text-amber-700 dark:text-amber-300 text-[10px] truncate">{{ substr($product->product->sku, 0, 8) }}</div>
                                        </div>
                                    </div>
                                </div>

                                {{-- Add to Cart Button --}}
                                <div class="mt-auto space-y-2 border-t border-sky-200/60 dark:border-neutral-700/50 pt-3">
                                    <button type="button" @click="$wire.addToCart('{{ $product->id }}')"
                                        class="w-full py-3 px-4 inline-flex items-center justify-center gap-2 text-sm font-bold rounded-lg border-0 bg-gradient-to-r from-yellow-500 to-amber-600 text-white shadow-lg transition-all duration-200 hover:from-yellow-600 hover:to-amber-700 hover:shadow-xl active:scale-95">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="col-span-12 flex items-center justify-center rounded-2xl border-2 border-sky-200/60 bg-gradient-to-br from-white via-blue-100/50 to-cyan-50/40 p-4 shadow-xl dark:border-neutral-700 dark:from-neutral-900 dark:via-blue-900/10 dark:to-neutral-900">
