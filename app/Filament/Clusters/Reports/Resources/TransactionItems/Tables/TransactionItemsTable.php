...
namespace App\Filament\Clusters\Reports\Resources\TransactionItems\Tables;
                ...
                Filter::make('store_id')
                    ->schema([
                        ...
                        return $query
                            ->when(
                                $data['store_id'],
                                fn(Builder $query, $cashierId): Builder => $query->whereRelation('transaction', 'store_id', $data['store_id']),
                            );
                    })
                    ->columnSpanFull(),
